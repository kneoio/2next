...
import com.semantyca.core.model.UserBilling;
...
import static com.semantyca.core.repository.table.TableNameResolver.USER_BILLING_ENTITY_NAME;
...
public class UserBillingRepository extends AsyncRepository {
    ...
    @Inject
    public UserBillingRepository(Pool client, ObjectMapper mapper) {
