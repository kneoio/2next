...
import static com.semantyca.core.repository.cnst.Tables.LANGUAGES_TABLE_NAME;
import static com.semantyca.core.repository.table.TableNameResolver.LANGUAGE_ENTITY_NAME;
...
public class LanguageRepository extends AsyncRepository {
    ...
    @Inject
    public LanguageRepository(Pool client, ObjectMapper mapper) {
