...
import com.semantyca.core.repository.cnst.Tables;
...
import static com.semantyca.core.repository.cnst.Tables.*;
...
public class ModuleRepository extends AsyncRepository {
    ...
    @Inject
    public ModuleRepository(Pool client, ObjectMapper mapper) {
