...
import com.semantyca.core.dto.document.UserSubscriptionDTO;
...
import com.semantyca.core.service.UserSubscriptionService;
...
@ApplicationScoped
public class UserSubscriptionController extends AbstractSecuredController<UserSubscription, UserSubscriptionDTO> {
    ...
    @Inject
    public UserSubscriptionController(UserService userService, UserSubscriptionService service) {
        super(userService);
    ...
    private void getAll(RoutingContext rc) {
        ...
        getContextUser(rc)
                .chain(user -> Uni.combine().all().unis(
                    ...
                    View<UserSubscriptionDTO> dtoEntries = new View<>(tuple.getItem2(),
                            tuple.getItem1(), page,
