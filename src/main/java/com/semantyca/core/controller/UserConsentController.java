...
import com.semantyca.core.dto.document.UserConsentDTO;
import com.semantyca.core.dto.form.FormPage;
import com.semantyca.core.dto.view.View;
import com.semantyca.core.dto.view.ViewPage;
import com.semantyca.core.model.cnst.LanguageCode;
import com.semantyca.core.model.UserConsent;
import com.semantyca.core.service.UserConsentService;
...
@ApplicationScoped
public class UserConsentController extends AbstractSecuredController<UserConsent, UserConsentDTO> {
    ...
    @Inject
    public UserConsentController(UserService userService, UserConsentService service) {
        super(userService);
    ...
    private void getAll(RoutingContext rc) {
        ...
        getContextUser(rc)
                .chain(user -> Uni.combine().all().unis(
                    ...
                    View<UserConsentDTO> dtoEntries = new View<>(tuple.getItem2(),
                            tuple.getItem1(), page,
    ...
    private void upsert(RoutingContext rc) {
        try {
            ...
            UserConsentDTO dto = json.mapTo(UserConsentDTO.class);
            String id = rc.pathParam("id");
