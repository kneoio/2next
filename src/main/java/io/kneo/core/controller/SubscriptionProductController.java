...
import io.kneo.core.service.SubscriptionProductService;
...
@ApplicationScoped
public class SubscriptionProductController extends AbstractSecuredController<SubscriptionProduct, SubscriptionProductDTO> {
    ...
    @Inject
    public SubscriptionProductController(UserService userService, SubscriptionProductService service) {
        super(userService);
        this.service = service;
    }

    public void setupRoutes(Router router) {
        String path = "/api/subscription-products";
    ...
    private void getAll(RoutingContext rc) {
        ...
        getContextUser(rc)
                .chain(user -> Uni.combine().all().unis(
                    ...
                    View<SubscriptionProductDTO> dtoEntries = new View<>(tuple.getItem2(),
                            tuple.getItem1(), page,
